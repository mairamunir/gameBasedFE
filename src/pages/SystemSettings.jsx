...
const SystemSettings = () => {
  ...
  useEffect(() => {
    const loadGeneral = async () => {
      try {
        ...
        const { siteName, siteDescription, supportEmail, maintenanceMode } =
          res.data;
  ...
  useEffect(() => {
    const loadNotifications = async () => {
      try {
        ...
        const { emailNotifications, adminAlerts, assessmentReminders } =
          res.data;
  ...
  useEffect(() => {
    const loadSecurity = async () => {
      try {
        ...
        const { twoFactorAuth, passwordExpiryDays, sessionTimeoutMins } =
          res.data;
        setTwoFactorAuth(twoFactorAuth);
        setPasswordExpiryDays(passwordExpiryDays.toString());
        setSessionTimeoutMins(sessionTimeoutMins.toString());
      } catch (err) {
  ...
  useEffect(() => {
    const loadIntegrations = async () => {
      try {
        ...
        const { apiKey, webhookUrl, enableWebhooks } = res.data;
        setApiKey(apiKey);
  ...
  // Handler: Save Security settings
  const handleSaveSecurity = async () => {
    try {
      await api.put("/api/settings/security", {
        twoFactorAuth,
  ...
  // Handler: Save Integration settings
  ...
  // If any section is still loading, show a loader
  if (
    loadingGeneral ||
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Send alerts to administrators for critical system
                        events.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="assessment-reminders">
                        Assessment Reminders
                      </Label>
                      <p className="text-sm text-muted-foreground">
                        Send reminder notifications to candidates about pending
                        assessments.
                      </p>
                    </div>
                    <Switch
